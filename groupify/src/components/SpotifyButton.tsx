...
export const SpotifyButton = ({ spotifyUrl, className = '' }: SpotifyButtonProps) => {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-2 rounded-md bg-green-500 px-4 py-2 text-white transition-colors hover:bg-green-600 ${className}`}
