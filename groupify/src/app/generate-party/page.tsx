...
export default function Page() {
  ...
  const partyTimestamp = useSelector(
    (state: RootState) => state.party.timestamp
  );
  const selectedPartyCode = useSelector(
  ...
  if (partyTimestamp !== null) {
    isPartyCodeExpired =
      new Date(partyTimestamp) < new Date(Date.now() - 1000 * 60 * 60);
  }
  ...
  return (
    <div className='generate-party-container'>
      <div className='generate-party-content'>
        ...
        <p className='generate-party-description'>
          Generate a party code to invite your friends to join you.
        </p>
        ...
        {!isPartyCodeValid && (
          <div className='flex flex-col items-center gap-4'>
            <div className='flex items-center gap-2'>
              <p className='rounded-md bg-gray-800 px-4 py-2 text-white'>
                Party code:{' '}
